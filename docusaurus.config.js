...
const config = {
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/agentic-AI/ai-textbook-physical-ai/tree/main/',
        },
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/robot-arm.svg',
      navbar: {
        title: 'Physical AI Textbook',
        logo: {
          alt: 'Sophisticated Tech Firm Logo',
          src: 'img/logo.png',
        },
        items: [
          {
          ...
          {
            href: 'https://github.com/agentic-AI/ai-textbook-physical-ai',
            label: 'GitHub',
            position: 'right',
          },
        ],
